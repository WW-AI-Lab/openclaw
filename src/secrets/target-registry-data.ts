...
const SECRET_TARGET_REGISTRY: SecretTargetRegistryEntry[] = [
  ...
  {
    id: "plugins.entries.metaso.config.webSearch.apiKey",
    targetType: "plugins.entries.metaso.config.webSearch.apiKey",
    configFile: "openclaw.json",
    pathPattern: "plugins.entries.metaso.config.webSearch.apiKey",
    secretShape: SECRET_INPUT_SHAPE,
    expectedResolvedValue: "string",
    includeInPlan: true,
    includeInConfigure: true,
  ...
  {
    id: "plugins.entries.openai-search.config.webSearch.apiKey",
    targetType: "plugins.entries.openai-search.config.webSearch.apiKey",
    configFile: "openclaw.json",
    pathPattern: "plugins.entries.openai-search.config.webSearch.apiKey",
    secretShape: SECRET_INPUT_SHAPE,
    expectedResolvedValue: "string",
    includeInPlan: true,
    includeInConfigure: true,
